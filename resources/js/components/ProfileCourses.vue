    ...
    <section id="profile">
        ...
        <section id="section-content">
            ...
            ================================== -->
                ...
                <section v-if="user_data.onrolled_courses.length > 0" class="section-content-3">
                    <h1 class="section-3-title">دورات</h1>
                    ...
                    <div class="content">
                        <div id="profile-courses" class="card-container d-flex justify-content-center gap-5 flex-wrap">
                                ...
                                <div v-for="onrolled_course in user_data.onrolled_courses" :key="onrolled_course.course.id" class="course-preview-card" style="width:285px;height:auto;">
                                    <router-link :to="'/courses/show-content/'+onrolled_course.course.id"><img :src="'/media/main/'+onrolled_course.course.img" alt="card-pic" class="card-pic"></router-link>
                                    <div class="category"><b>{{ onrolled_course.course.category.name }}</b></div>
                                    <router-link :to="'/courses/show-content/'+onrolled_course.course.id"><div class="title">{{ onrolled_course.course.title }}</div></router-link>
                                    <div class="author">دورة مقدمة من قبل : {{ onrolled_course.course.instractor }}</div>
                ...
                <section v-else class="section-content-3">
                    <h1 class="section-3-title">دورات</h1>
                    <div class="content">
                        <h5 class="profile-no-content">عذرا ليس لديك دورات في الوقت الحالي لعرضها</h5>
                    </div>
                </section>
                <!-- =============================
                ============ section 3 ============
    ...
    export default {
        ...
        methods: {
            async getUserCourses() {
                ...
                axios.get("api/profile/get-user-courses", {
                    headers: {
