    ...
    <section  class="about-us-content">
        ...
        <div class="ratings">
            <div class="rating">
                ...
                <div class="subtitle">طالب راض</div>
            </div>
            <div class="rating">
                <div class="title">2k+</div>
                <div class="subtitle">دورة</div>
            </div>
            <div class="rating">
                <div class="title">1200+</div>
                <div class="subtitle">طالب سعيد</div>
            </div>
            <div class="rating">
                <div class="title">6+</div>
                <div class="subtitle">اعوام خبره</div>
            </div>
        </div>
        ...
        <div class="about-us">
            ...
            <div class="subtitle">
                ...
                مقاطع من هذا النص، وعاد لينتشر مرة أخرى مؤخراَ مع ظهور برامج النشر الإلكتروني مثل "ألدوس بايج مايكر" (Aldus
            ...
            <div class="center-sec">
                ...
                <div class="item">
                    ...
                    <div class="t">
                        ...
                        <p class="sub-title">نسعى للتعاقد مع أفضل الخبرات في المجالات الاستشارية والتدريبية عملا بأفضل
                            المعايير في انتاج البرامج</p>
                    </div>
                </div>
                <!-- item 4 -->
                <div class="item">
                    ...
                    <div class="t">
                        ...
                        <p class="sub-title"> نوفرها للمشاركين في برامجنا التدريبية بأنواعها المختلفة من مصادرها الرئيسية
                            وشبكة شركائنا.</p>
                    </div>
                </div>
            </div>
...
.about-us-hero {
  background-image: url(../build/assets/about-hero.png);
  /* background-position: 0 -171px; */
  background-size: cover;
  background-repeat: no-repeat;
  width: 100%;
  height: 587px;
  padding: 91px 103px 0 0;
  position: relative;
}
.about-us-hero::after {
  content: "";
...
/* ================== ratings ================== */
.about-us-content .ratings {
  width: 100%;
  display: grid;
  grid-template-columns: repeat(4, 1fr);
}

.about-us-content .ratings .rating {
  display: flex;
  flex-direction: column;
}

.about-us-content .ratings .title {
...
.about-us-content .ratings .subtitle {
  color: #1c1c1c;
  text-align: center;
...
.strong_points .center-sec .item p {
  font-size: clamp(18px, calc(100vw * 0.014), 20px);
  font-style: normal;
  font-weight: 700;
  line-height: 23px;
  color: #505050;
